-- Migration for Enhanced Client Search (Task 043)
...
-- Create composite index for salon-specific searches
CREATE INDEX IF NOT EXISTS idx_clients_salon_name_trgm ON clients USING GIN (salon_id, full_name gin_trgm_ops);
...
COMMENT ON INDEX idx_clients_salon_name_trgm IS 'Composite index for salon-specific client name searches';
